...
public class PlayerController : MonoBehaviour
{
    ...
    [Header("Movement")]
    /// <summary>
    /// movement code created by Acacia-Developer
    /// </summary>
    ...
    void UpdatePickup() 
    {
        //raycast detect pickable object
        //click object
        //read object-tag
        ...
        {          
            //cursor changes into hand cursor
            OpenHandIcon.SetActive(true);
            Debug.Log("pickable object detected");
            ...
            && hit.collider.TryGetComponent<ItemObject>(out ItemObject item))
            {
                ...
                //play sound - preferrably change this in class
                if (hit.collider.gameObject.CompareTag("Mushroom"))
                {
                    GM.mushroomClicked = true;                   
                }
            }
        }
    }
